...
class BookInfoViwerBodyPage extends HookConsumerWidget {
  ...
  BookInfoViwerBodyPage(this.book,
      {super.key, this.isLoading = false, required this.onRefresh});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(children: [
                  ...
                  Row(
                    ...
                    children: [
                      Chip(
                        ...
                        label: Text(
                            book.edition != null ? "Ed. ${book.edition}" : "-"),
                      ),
                      Chip(
                  ...
                  ListView(
                    ...
                    children: [
                      ListTile(
                          title: const Text("ISBN"), trailing: Text(book.isbn)),
