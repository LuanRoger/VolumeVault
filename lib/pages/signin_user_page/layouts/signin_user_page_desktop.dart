...
class SigninUserPageDesktop extends HookConsumerWidget {
  final SigninUserPageDesktopCommands _commands =
      SigninUserPageDesktopCommands();
  final GlobalKey<FormState> _signinFormKey = GlobalKey<FormState>();

  SigninUserPageDesktop({super.key});
