...
class LoginSection extends HookConsumerWidget {
  ...
  LoginSection({super.key, this.onSigninButtonPressed});
              ...
              ElevatedButton(
                  onPressed: () async {
                    ...
                    if (loginResult != LoginAuthResult.success) {
                      SnackbarUtils.showUserLoginAuthErrorSnackbar(context,
                  ...
                  child:
                      Text(AppLocalizations.of(context)!.loginButtonLoginPage)),
            ],
          ),
        ),
        Row(
          ...
          children: [
            Text(AppLocalizations.of(context)!.doesNotHaveAccountLoginPage),
            TextButton(
              onPressed: onSigninButtonPressed,
              child: Text(AppLocalizations.of(context)!.signinButtonLoginPage),
            ),
          ],
        ),
      ],
